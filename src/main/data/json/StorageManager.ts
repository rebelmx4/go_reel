// main/data/json/StorageManager.ts
...
export class StorageManager extends BaseJsonManager<StorageSettings> {
  ...
  // --- 基础路径获取 ---
  public getVideoSourcePath() { return this.data.video_source; }
  public getStagedPath() { return this.data.staged_path; }
  public getScreenshotExportPath() { return this.data.screenshot_export_path; }


  // --- 派生子目录获取 ---
  public getTrashPath() { return path.join(this.data.staged_path, SUB_DIRS.TRASH); }
