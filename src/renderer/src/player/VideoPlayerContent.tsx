...
import { ActionIcon, Box, Center, rem, Stack, Text, Tooltip } from '@mantine/core'
import {
  IconArrowsLeftRight,
  IconClock,
  IconFilter,
  ...
  IconStar,
  IconTags
} from '@tabler/icons-react' // 引入标签图标
import { EliteSidebar } from './sidebars/EliteSidebar'
import { useClipStore, usePlayerStore, usePlaylistStore, useScreenshotStore } from '../stores'
