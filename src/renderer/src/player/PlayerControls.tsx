...
import {
    ...
    IconThumbDown, IconThumbUp, IconDots
        ...
        >
            ...
            <Group justify="space-between" align="center">
                <Group gap="xs">
                        ...
                        >
                            ...
                            {displayScore > 0 && (
                                <Box style={{
                                    ...
                                    fontWeight: 'bold', border: '1px solid #ccc', lineHeight: '12px'
                                }}>
                                    {displayScore}
                                </Box>
                            )}
                    ...
                    <Menu shadow="md" width={200} position="top-start" withArrow>
                        ...
                        <Menu.Dropdown style={{ backgroundColor: '#1a1a1a', border: '1px solid #333' }}>
                            ...
                            <Menu.Item
                                leftSection={skipFrameMode ? <IconColumns3 size={16} /> : <IconArrowRight size={16} />}
                ...
                <Group gap="lg">
                    {/* 音量 */}
                    <Group gap="xs">
                        <Slider value={volume} onChange={setVolume} style={{ width: 80 }} size="xs" color="blue" />
                    </Group>
